...
# Esto permite leer el asterisco * del .env
...
# --- CONFIGURACIÓN DE CELERY (COLA DE TAREAS) ---
...
REST_FRAMEWORK = {
    ...
    # ... otras configuraciones si tenías
}

# Configuración básica de JWT (Opcional, pero recomendada)
